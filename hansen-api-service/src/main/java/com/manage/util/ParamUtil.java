...
import com.manage.core.page.Page;
import com.manage.model.Parameter;
import com.manage.redis.Strings;
import com.manage.service.ParameterService;
    ...
    public synchronized void reload() {
        try {
            ...
            if (updateToken == null || "".equalsIgnoreCase(updateToken)) {
                Strings.setEx(RedisKey.SYS_PARAM_UPDTOKEN.getKey(), RedisKey.SYS_PARAM_UPDTOKEN.getSeconds(), UUIDUtil.getUUID());
                updateToken = Strings.get(RedisKey.SYS_PARAM_UPDTOKEN.getKey());
            }
