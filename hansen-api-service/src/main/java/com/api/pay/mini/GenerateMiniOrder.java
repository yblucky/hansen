package com.api.pay.mini;

import com.alibaba.fastjson.JSON;
import com.api.pay.h5.RequestInfo;
import com.api.pay.vo.QueryOrderVo;
...
public class GenerateMiniOrder {
    ...
    public Map<String, String> generate(String money, String ip, String attach, String outTradeNo, String openid, String notyfyUrl) {
        ...
        com.api.pay.h5.RequestInfo requestInfo = buildOrderRequestInfo(money, ip, outTradeNo, attach, openid, notyfyUrl);
        String info = buildOrderRequestInfoXml(requestInfo);
        logger.debug(info);
        com.api.pay.h5.ResponseInfo resp = post(info);
        if (resp == null) {
     ...
     * @return
     */
    public com.api.pay.h5.RequestInfo buildOrderRequestInfo(String money, String ip, String outTradeNo, String attach, String openid, String notyfyUrl) {
        // 生成订单对象
        com.api.pay.h5.RequestInfo unifiedOrderRequest = new com.api.pay.h5.RequestInfo();
     ...
     * @return
     */
    public String buildOrderRequestInfoXml(com.api.pay.h5.RequestInfo requestInfo) {
        // 将订单对象转为xml格式
        XStream xStream = new XStream(new DomDriver("utf-8"));
        xStream.alias("xml", com.api.pay.h5.RequestInfo.class);// 根元素名需要是xml
     ...
     * @return
     */
    public com.api.pay.h5.ResponseInfo post(String orderInfo) {
        ...
        try {
            ...
            xStream.alias("xml", com.api.pay.h5.ResponseInfo.class);
            com.api.pay.h5.ResponseInfo unifiedOrderRespose = (com.api.pay.h5.ResponseInfo) xStream.fromXML(sb.toString());
     ...
     * @return
     */
    public Map<String, String> buildResponseInfoOut(com.api.pay.h5.ResponseInfo resp) {
    ...
    public static void main(String[] args) {
        ...
        com.api.pay.h5.RequestInfo requestInfo = new RequestInfo();
