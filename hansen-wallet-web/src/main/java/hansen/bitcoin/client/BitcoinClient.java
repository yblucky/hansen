...
import hansen.bitcoin.client.exceptions.BitcoinClientException;
...
public class BitcoinClient {
     ...
     * @since 0.3.18
     */
    public List<TransactionInfo> listTransactions(String account, int count, int from) {
        if (account == null) {
            account = "";
        }
        ...
        try {
            ...
            parameters.add(0, account);
            parameters.add(1, count);
            parameters.add(2, from);
     ...
     * @since 0.3.18
     */
    public JSONObject getTransactionJSON(String txId) {
        try {
