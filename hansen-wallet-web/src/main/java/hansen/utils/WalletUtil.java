...
import com.api.constant.ENumCode;
...
public class WalletUtil {
    public static BitcoinClient client = BitcoinClientFactory.getBitcoinClient("rtb");
    ...
    // 查询单个账户的交易记录
    public static List<TransactionInfo> listTransactions(String account, int count, int from) {
    ...
    public static TransactionInfo parseTransactionInfo(JSONObject transactionInfo) {
